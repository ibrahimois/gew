...
> plan's row in `docs/plans/README.md`.
>
...
- **Depends on**: `docs/plans/001-provider-core-and-gitea.md`,
  `docs/plans/002-github-adapter.md`, `docs/plans/003-gitlab-adapter.md`,
  `docs/plans/004-bitbucket-cloud-adapter.md`, and
  `docs/plans/005-azure-devops-adapter.md`
...
- `docs/plans/README.md` status only when execution is complete
